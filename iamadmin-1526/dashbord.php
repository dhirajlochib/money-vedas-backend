      ...
      <div class="container-fluid">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
              <h3>User</h3>
                <p>Go to User Panel</p>
              </div>
              <div class="icon">
                <i class="fas fa-user-plus"></i>
              </div>
              <a href="../login.php" class="small-box-footer">
...
<?php
        $agent_count_data = mysqli_fetch_array(mysqli_query($conn, "SELECT count(agent_id) total_agent FROM `agent`"));
     ...
     ?>
        ...
        <div class="col-lg-3 col-6">
          ...
          <?php
        $agent_count_data = mysqli_fetch_array(mysqli_query($conn, "SELECT count(agent_id) total_agent FROM `agent` WHERE  `status`='1' "));
     ...
     ?>
          ...
          <?php
        $agent_count_data = mysqli_fetch_array(mysqli_query($conn, "SELECT count(agent_id) total_agent FROM `agent` WHERE  `status`='0' "));

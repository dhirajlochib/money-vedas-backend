  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-3">Transfer Fund - DBSERVICES</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <?php if (isset($_SESSION['w_pass'])){
              ...
              elseif ($_SESSION['w_pass']==6) {
                ?>
              <div class="alert alert-danger alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  <h5><i class="icon fas fa-ban"></i> Alert!</h5>
                  <?php
              echo  "Wrong Agent Id, Please Check And Try Again!";
                  ?>
...
<?php
            ...
            <div class="card card-primary">
              ...
              <div class="card-header">
                <h3 class="card-title">Transfer Your Amount</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="req_hand.php" >
                <div class="card-body">
                  <div class="form-group">
                    <label for="uname">Reciver's User ID</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="amount" id="exampleInputPassword1" step="10" max="10000" placeholder="Amount" >
                  </div>

                  <div class="form-group">
                    <label for="bal">Enter Your Password</label>
                ...
                <div class="card-footer">
                  <button type="submit" name="transfer_btn" class="btn btn-primary">Transfer Fund</button>
                </div>
              </form>
            </div>
        </div>

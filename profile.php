...
<?php $bal = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM `agent` WHERE `agent_id`='$my_id'"));?>
            ...
            <label for="agent_id">Agent Id</label>
              ...
              <label for="pay_num">Account/upi Address</label>
              <div class="input-group mb-3">
                <input type="text" class="form-control" name="pay_num" value="<?php echo $bal['acc_number']; ?>" placeholder="Account/upi Address">
                <div class="input-group-append">
                  <div class="input-group-text">
              ...
              <label for="pay_name">IFSC Code(optional)</label>
              <div class="input-group mb-3">
                <input type="text" class="form-control" name="pay_name" value="<?php echo $bal['ifsc_code']; ?>" placeholder="IFSC Code(optional)">
                <div class="input-group-append">
                  <div class="input-group-text">
                    <span class="fas fa-lock"></span>
                  </div>
